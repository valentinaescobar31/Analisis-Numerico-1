...
plot(xis, pch=19, type="p", xlab= "eje x", ylab= "eje y", col="black", main="3. Método Euler")
...
Cuarto punto: 
Implemente en R el algoritmo y aplíquelo para resolver la ecuación anterior 
